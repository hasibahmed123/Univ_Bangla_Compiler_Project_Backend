...
- [ ] Update main.cpp: Update tests array to all 14 from bangla_compiler_tests.txt, update descriptions.
- [ ] Compile and run tests using run.bat to verify all outputs.
